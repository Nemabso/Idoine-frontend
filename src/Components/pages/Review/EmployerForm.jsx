...
export default function EmployerForm({throwMsg}) {
    const ratedQuestions = [
        'Les objectifs visés par la formation ont-ils étés atteints selon vous ?',
    ];
    ...
    const mcq = [
        ...
        {label: "Depuis la fin de la formation, a quelle fréquence votre collaborateur a-t-il mis en pratique les connaissances acquises ?", options: ["Régulièrement", "Occasionnellement", "Jamais"]},
    ...
    const reviewInitialState = { writerName: "", companyName: "", service: "", formationLocation: "", startDate: "", endDate: "", duration: "", 
                ...
                <Col className='p-3'>
                    <form onSubmit={handleSubmit} className='container p-3 rounded bg-light'>
                        ...
                        <div className='p-4'>
                            ...
                            <TextInput {... {name: 'companyName', label: 'Nom de votre entreprise', placeholder: 'Entreprise', handleChanges: handleChange, value: review.companyName, isRequired: true}} />
                            ...
                            <TextInput {... {name: 'formationLocation', label: 'Lieu de la formation', placeholder: 'Lieu de la formation', handleChanges: handleChange, value: review.formationLocation, isRequired: true}} />
                            <div className='mb-3'>
                            ...
                            <Mcq handleChanges={handleMcqChange} {...mcq[4]} />
